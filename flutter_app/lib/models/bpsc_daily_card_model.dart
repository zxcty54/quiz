...
class BpscDailyCardModel {
  ...
  factory BpscDailyCardModel.fromUniversalJson(
    ...
    final skipKeys = [
      ...
      'plant_name', 'report_title', 'monument_name', 'product_name', 'mineral_name',
      'river_name', 'soil_name', 'waterbody_name', 'sanctuary_name', 'title',
      'popular_title', 'popular_tag', 'category', 'era_category', 'energy_type',
      'crop_type', 'official_status', 'nature', 'regional_nickname', 'exam_facts_and_pyqs'
    ];
    ...
    json.forEach((key, value) {
      ...
      if (value is Map) {
        value.forEach((subKey, subVal) {
          ...
          if (['explanation', 'background_context', 'detailed_role'].contains(subKey)) {
