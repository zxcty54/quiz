...
class _AiChatScreenState extends State<AiChatScreen> {
  ...
  Future<void> _pickAndLoadQwenModel() async {
    ...
    try {
      ...
      contextParams.nCtx = 256;   // Ultra-safe low context to prevent phone crash
...
Create 2 multiple-choice questions for the user topic.
Format:
Q1. [Question]
A) [Option 1]
B) [Option 2]
      ...
      setState(() {
        if (_messages.isNotEmpty && _messages.last['role'] == 'assistant') {
          _messages[_messages.length - 1] = {
            ...
            'time': '${stopwatch.elapsedMilliseconds}ms (Qwen 0.5B LLM)',
          };
        }
        _isGenerating = false;
      });
