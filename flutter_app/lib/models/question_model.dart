...
class _RevisionTabState extends State<RevisionTab> {
  ...
  // 1️⃣ Pehle Disk Storage se instant load, fir background fetch
  ...
  // 📰 SPECIAL CURRENT AFFAIRS DIRECT LOADER (Uses Question.fromJson)
  Future<void> _openCurrentAffairsSection({
    ...
    try {
      ...
      if (res.statusCode == 200) {
        ...
        // 🌟 Direct parsing using your Question.fromJson
