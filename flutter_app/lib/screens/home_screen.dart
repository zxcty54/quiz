...
class _HomeScreenState extends State<HomeScreen> with WidgetsBindingObserver {
  ...
  Future<void> _loadAllConfigs() async {
    ...
    try {
      _appConfig = jsonDecode(await rootBundle.loadString('assets/data/app_config.json'));
      _homeData = jsonDecode(await rootBundle.loadString('assets/data/home_data.json'));
      _subjectMapping = jsonDecode(await rootBundle.loadString('assets/data/subject_mapping.json'));
      _sectionalData = jsonDecode(await rootBundle.loadString('assets/data/sectional_data.json'));
    } catch (e) {
