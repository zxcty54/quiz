...
class _SavedQuestionsScreenState extends State<SavedQuestionsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('⭐ Bookmarked Questions', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
        actions: [
          IconButton(
            icon: Container(
            ...
            return Center(
              child: Column(
                ...
                children: const [
                  ...
                  SizedBox(height: 10),
                  Text('No Bookmarked Questions Yet', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                  SizedBox(height: 4),
                  Text('Questions test ke dauran bookmark karein, wo yahan save ho jayenge.', style: TextStyle(color: Colors.grey, fontSize: 12)),
                ],
              ),
            );
          }
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Text('Question ${index + 1}', style: const TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF2563EB), fontSize: 12)),
                          IconButton(
                      ...
                      if (q.explanation.isNotEmpty) ...[
                        ...
                        Text('💡 Solution: ${q.explanation}', style: const TextStyle(fontSize: 11.5, color: Colors.grey)),
                      ]
                    ],
                  ),
                ),
