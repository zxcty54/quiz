import 'dart:ui'; // 👈 Added for ImageFilter frosted glass blur
import 'dart:convert';
...
class _HomeTabState extends State<HomeTab> {
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // 🛡️ 2. HERO TRUST BANNER (GLASSMORPHIC)
  ...
  // 🛡️ 1. HERO BANNER (MODERN GRADIENT WITH GLASSMORPHIC ACCENTS)
  Widget _buildTrustHeroBanner() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: const Color(0xFF312E81).withOpacity(widget.isDarkMode ? 0.4 : 0.25),
            blurRadius: 20,
      ...
      child: ClipRRect(
        ...
        child: Stack(
          children: [
            // 1. BASE GRADIENT BACKGROUND LAYER
            Positioned.fill(
              child: Container(
                decoration: BoxDecoration(
            ...
            // 2. AMBIENT GLOW CIRCLES (FOR GLASS REFRACTION)
            Positioned(
              top: -30,
              right: -30,
              child: Container(
            ...
            // 3. FROSTED GLASS OVERLAY WITH BACKDROP FILTER BLUR
            BackdropFilter(
              filter: ImageFilter.blur(sigmaX: 12, sigmaY: 12),
              child: Container(
                padding: const EdgeInsets.all(20),
                decoration: BoxDecoration(
                  color: Colors.white.withOpacity(widget.isDarkMode ? 0.05 : 0.08),
                  borderRadius: BorderRadius.circular(24),
                  border: Border.all(
