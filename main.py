...
def generate_clean_summary(raw_text, target_date_str, is_national=False):
    ...
    3. REJECT LOCAL/TRIVIAL NEWS: District-level train halts, traffic advisories, local crime, and local political fights.Reject State based news which is not important for national and irrelevent for BPSC Exams.
