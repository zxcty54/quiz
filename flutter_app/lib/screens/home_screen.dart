                  ...
                  DrawerHeader(
                    ...
                    child: Column(
                      ...
                      children: const [
                        ...
                        SizedBox(height: 10),
                        Text('MockTester', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
                        SizedBox(height: 2),
                        Text('Aspirants Prep Platform', style: TextStyle(color: Colors.white70, fontSize: 12)),
                      ],
                    ),
                  ),
                  ListTile(
