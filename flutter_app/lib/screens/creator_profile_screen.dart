...
class _CreatorProfileScreenState extends State<CreatorProfileScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: isDark ? const Color(0xFF0F172A) : const Color(0xFFF8FAFC),
      appBar: AppBar(
        title: Text(_profile!['name'] ?? 'Mentor Profile', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
        elevation: 0.5,
      ),
      body: NestedScrollView(
        ...
        body: TabBarView(
          ...
          children: [
            // Tab 1: Mocks List
            _mocks.isEmpty
                ? const Center(child: Text('No mock tests published yet.'))
                : ListView.builder(
            ...
            // Tab 2: Posts & Gossip List
            _posts.isEmpty
                ? const Center(child: Text('No community posts shared yet.'))
                : ListView.builder(
                    padding: const EdgeInsets.all(12),
